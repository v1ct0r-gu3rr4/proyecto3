package com.ventas.application.views.ordenes;
...
@Route(value = "orden", layout = MainView.class)
@PageTitle("Ordenes")
@CssImport(value = "./styles/views/ordenes/ordenes-view.css", include="lumo-badge")
@JsModule("@vaadin/vaadin-lumo-styles/badge.js")
public class OrdenesView extends Div {
